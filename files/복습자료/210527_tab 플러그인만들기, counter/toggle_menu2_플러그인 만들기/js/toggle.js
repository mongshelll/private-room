...
/* 
일반 함수형 코드를 객체 지향형 코드로 변환할 때 

1. 생성자 함수 정의 
2. new 키워드로 인스턴스 복사 
3. 인스턴스 복사시 생성자 함수의 인수로 옵션값 전달 
4. 생성자 함수 안쪽에서 this.init(), this.bindingEvent() 호출 
5. 모든 함수를 프로토타입에 등록 
6. 함수 안쪽의 전역변수를 this.으로 인스턴스에 전달 
7. bindingEvent 안쪽의 이벤트문에서의 this값과 인스턴스 this의 충돌을 피하기 위해서 지역변수 self 에 인스턴스 this를 옮겨담음 
*/