...
var ebSwiper = (function(){
	...
	return {
		rollingSwiper : function(){
			...
			swiper1 = new Swiper(".mySwiper1", swiperOption);
			swiper2 = new Swiper(".mySwiper2", swiperOption);
			swiper3 = new Swiper(".mySwiper3", swiperOption);
			swiper4 = new Swiper(".mySwiper4", swiperOption);

			swiper1.on("activeIndexChange", ebSwiper.activeSlide);
		},
		activeSlide : function(){
			var first = $('.roll-first-wrap .swiper-slide');
			var second = $('.roll-second-wrap .swiper');
			var index = this.realIndex;

			console.log(second.eq(index));

			second.eq(index).removeClass('hidden').siblings().addClass('hidden');
		},
		tetest: function(){
			console.log('test');
		}
